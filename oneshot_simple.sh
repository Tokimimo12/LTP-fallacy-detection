#!/bin/bash
#SBATCH --job-name=oneshot_simple        # Job name
#SBATCH --output=oneshot_simple-%j.log
...
python3 -u new_prompting.py --mode one-shot --model llama
python3 -u new_prompting.py --mode one-shot --model llama-instruct
python3 -u new_prompting.py --mode one-shot --model menda
python3 -u new_prompting.py --mode one-shot --model phi-4
python3 -u new_prompting.py --mode one-shot --model mistralai
python3 -u new_prompting.py --mode one-shot --model tinyllama
