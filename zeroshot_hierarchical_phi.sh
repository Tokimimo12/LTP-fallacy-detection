#!/bin/bash
#SBATCH --job-name=zeroshot_hierarchical_phi        # Job name
#SBATCH --output=zeroshot_hierarchical_phi-%j.log
...
mkdir -p /scratch/$USER/LTP/LTP-fallacy-detection/prompting_results/hierarchical/$SLURM_JOB_ID
...
cp -r $TMPDIR/LTP-fallacy-detection/prompting/results /scratch/$USER/LTP/LTP-fallacy-detection/prompting_results/hierarchical/$SLURM_JOB_ID
