#!/bin/bash
#SBATCH --job-name=oneshot_flat_PHI        # Job name
#SBATCH --output=oneshot_flat_PHI-%j.log
#SBATCH --nodes=1                     # Number of nodes (use 1 node)
#SBATCH --ntasks=1                    # One task
#SBATCH --gpus-per-node=v100:1
#SBATCH --time=1:30:00              # Time limit for the job
#SBATCH --mem=20GB
...
python3 -u flattened_prompting.py --mode one-shot --model phi-4 --batch_size 4
